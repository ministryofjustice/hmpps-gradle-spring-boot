...
class KotlinPluginManager(override val project: Project) : PluginManager {
  ...
  private fun addDependencies() {
    project.dependencies.add("implementation", "tools.jackson.module:jackson-module-kotlin:3.0.3")
    project.dependencies.add("implementation", "com.fasterxml.jackson.module:jackson-module-kotlin:2.20.1")
